...
#define GRP_APPINAPP_MAIN			"appinapp.main"
#define GRP_MINI_PANNEL			"mini_pannel"
#define GRP_MINI_TITLE	"mini/title"
...
#else
#define CALC_FUN_BEG()	LOG(LOG_DEBUG,"LAUNCH","[calculator:Application:%s:IN]", __FUNCTION__);
#define CALC_FUN_END()	LOG(LOG_DEBUG,"LAUNCH","[calculator:Application:%s:OUT]", __FUNCTION__);
#endif
...
#define CALC_MSG_WRONG_FORMAT       _("IDS_CCL_POP_INPUT_ERROR")

#define CALC_MSG_CLEAR_HISTTORY      _("IDS_CCL_OPT_CLEAR_HISTORY")
#define CALC_MSG_MINIMISE      _("IDS_CCL_OPT_MINIMISE")
#define CALC_MSG_MINIMODE_TITLE      _("IDS_CCL_BODY_CALCULATOR")
...
#define DESKTOP_MODE_ICON      "/opt/share/icons/default/small/com.samsung.calculator.png"
...
struct appdata {
	...
	Elm_Object_Item *clear_item;
#ifdef SAVE_HISTORY
	Evas_Object *hist_scroll;
	Evas_Object *hist_area;
	Eina_Bool panel_show;
#endif
	Evas_Object *window_icon;  //only show it when in desktop mode;
};
